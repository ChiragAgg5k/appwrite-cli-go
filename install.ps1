...
# REPO
$GITHUB_x64_URL = "https://github.com/ChiragAgg5k/appwrite-cli-go/releases/download/0.7.14/appwrite-cli-win-x64.exe"
$GITHUB_arm64_URL = "https://github.com/ChiragAgg5k/appwrite-cli-go/releases/download/0.7.14/appwrite-cli-win-arm64.exe"
