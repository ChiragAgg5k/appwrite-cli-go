...
// ProviderRepositoryFramework Model
type ProviderRepositoryFramework struct {
...
func (model ProviderRepositoryFramework) New(data []byte) *ProviderRepositoryFramework {
	model.data = data
	return &model
}

func (model *ProviderRepositoryFramework) Decode(value interface{}) error {
	if len(model.data) <= 0 {
