...
type UsageProject struct {
	...
	EmbeddingsTextTotal int `json:"embeddingsTextTotal"`
	// Total aggregated number of tokens processed by text.
	EmbeddingsTextTokensTotal int `json:"embeddingsTextTokensTotal"`
	// Total aggregated duration spent generating text embeddings.
	EmbeddingsTextDurationTotal int `json:"embeddingsTextDurationTotal"`
	// Total aggregated number of errors while generating text embeddings.
	EmbeddingsTextErrorsTotal int `json:"embeddingsTextErrorsTotal"`
