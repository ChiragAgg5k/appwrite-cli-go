...
func (srv *Oauth2) WithLogoutIdTokenHint(v string) LogoutOption {
	return func(o *LogoutOptions) {
		o.IdTokenHint = v
		o.enabledSetters["IdTokenHint"] = true
	}
}
func (srv *Oauth2) WithLogoutLogoutHint(v string) LogoutOption {
	return func(o *LogoutOptions) {
		o.LogoutHint = v
		o.enabledSetters["LogoutHint"] = true
	}
}
func (srv *Oauth2) WithLogoutClientId(v string) LogoutOption {
	return func(o *LogoutOptions) {
		o.ClientId = v
		o.enabledSetters["ClientId"] = true
	}
}
func (srv *Oauth2) WithLogoutPostLogoutRedirectUri(v string) LogoutOption {
	return func(o *LogoutOptions) {
		o.PostLogoutRedirectUri = v
		o.enabledSetters["PostLogoutRedirectUri"] = true
	}
}
func (srv *Oauth2) WithLogoutState(v string) LogoutOption {
	return func(o *LogoutOptions) {
		o.State = v
		o.enabledSetters["State"] = true
	}
}
func (srv *Oauth2) WithLogoutUiLocales(v string) LogoutOption {
	return func(o *LogoutOptions) {
		o.UiLocales = v
...
func (srv *Oauth2) Logout(optionalSetters ...LogoutOption)(*interface{}, error) {
	...
	params := map[string]interface{}{}
	if options.enabledSetters["IdTokenHint"] {
		params["id_token_hint"] = options.IdTokenHint
	}
	if options.enabledSetters["LogoutHint"] {
		params["logout_hint"] = options.LogoutHint
	}
	if options.enabledSetters["ClientId"] {
		params["client_id"] = options.ClientId
	}
	if options.enabledSetters["PostLogoutRedirectUri"] {
		params["post_logout_redirect_uri"] = options.PostLogoutRedirectUri
	}
	if options.enabledSetters["State"] {
		params["state"] = options.State
	}
	if options.enabledSetters["UiLocales"] {
...
func (srv *Oauth2) WithLogoutPostLogoutHint(v string) LogoutPostOption {
	return func(o *LogoutPostOptions) {
		o.LogoutHint = v
		o.enabledSetters["LogoutHint"] = true
	}
}
func (srv *Oauth2) WithLogoutPostClientId(v string) LogoutPostOption {
	return func(o *LogoutPostOptions) {
		o.ClientId = v
		o.enabledSetters["ClientId"] = true
	}
}
func (srv *Oauth2) WithLogoutPostPostLogoutRedirectUri(v string) LogoutPostOption {
	return func(o *LogoutPostOptions) {
		o.PostLogoutRedirectUri = v
		o.enabledSetters["PostLogoutRedirectUri"] = true
	}
}
func (srv *Oauth2) WithLogoutPostState(v string) LogoutPostOption {
	return func(o *LogoutPostOptions) {
		o.State = v
		o.enabledSetters["State"] = true
	}
}
func (srv *Oauth2) WithLogoutPostUiLocales(v string) LogoutPostOption {
	return func(o *LogoutPostOptions) {
		o.UiLocales = v
		o.enabledSetters["UiLocales"] = true
	}
