...
func (srv *Sites) WithListTemplatesFrameworks(v []string) ListTemplatesOption {
	return func(o *ListTemplatesOptions) {
		o.Frameworks = v
		o.enabledSetters["Frameworks"] = true
	}
}
func (srv *Sites) WithListTemplatesUseCases(v []string) ListTemplatesOption {
	return func(o *ListTemplatesOptions) {
		o.UseCases = v
		o.enabledSetters["UseCases"] = true
	}
}
func (srv *Sites) WithListTemplatesLimit(v int) ListTemplatesOption {
	return func(o *ListTemplatesOptions) {
		o.Limit = v
		o.enabledSetters["Limit"] = true
	}
}
func (srv *Sites) WithListTemplatesOffset(v int) ListTemplatesOption {
	return func(o *ListTemplatesOptions) {
		o.Offset = v
...
// ListTemplates list available site templates. You can use template details
// in [createSite](/docs/references/cloud/server-nodejs/sites#create) method.
func (srv *Sites) ListTemplates(optionalSetters ...ListTemplatesOption)(*models.TemplateSiteList, error) {
	...
	params := map[string]interface{}{}
	if options.enabledSetters["Frameworks"] {
		params["frameworks"] = options.Frameworks
	}
	...
	if strings.HasPrefix(resp.Type, "application/json") {
		...
		parsed := models.TemplateSiteList{}.New(bytes)
	...
	var parsed models.TemplateSiteList
	parsed, ok := resp.Result.(models.TemplateSiteList)
	if !ok {
		return nil, errors.New("unexpected response type")
	}
	return &parsed, nil
...
func (srv *Sites) GetTemplate(TemplateId string)(*models.TemplateSite, error) {
	...
	if strings.HasPrefix(resp.Type, "application/json") {
		...
		parsed := models.TemplateSite{}.New(bytes)
	...
	var parsed models.TemplateSite
	parsed, ok := resp.Result.(models.TemplateSite)
	if !ok {
		return nil, errors.New("unexpected response type")
	}
	return &parsed, nil
