...
func (srv *Mongo) WithCreateStandbyRegion(v string) CreateOption {
	return func(o *CreateOptions) {
		o.StandbyRegion = v
...
func (srv *Mongo) WithUpdateCrossRegionReplicas(v int) UpdateOption {
	return func(o *UpdateOptions) {
		o.CrossRegionReplicas = v
		o.enabledSetters["CrossRegionReplicas"] = true
	}
}
func (srv *Mongo) WithUpdateStandbyRegion(v string) UpdateOption {
	return func(o *UpdateOptions) {
		o.StandbyRegion = v
		o.enabledSetters["StandbyRegion"] = true
	}
