...
func (srv *Postgresql) WithCreateStandbyRegion(v string) CreateOption {
	return func(o *CreateOptions) {
		o.StandbyRegion = v
		o.enabledSetters["StandbyRegion"] = true
	}
}
...
func (srv *Postgresql) Create(DatabaseId string, Name string, optionalSetters ...CreateOption) (*models.DedicatedDatabase, error) {
	...
	if options.enabledSetters["StandbyRegion"] {
		params["standbyRegion"] = options.StandbyRegion
	}
...
func (srv *Postgresql) WithUpdateCrossRegionReplicas(v int) UpdateOption {
	return func(o *UpdateOptions) {
		o.CrossRegionReplicas = v
		o.enabledSetters["CrossRegionReplicas"] = true
	}
}
func (srv *Postgresql) WithUpdateStandbyRegion(v string) UpdateOption {
	return func(o *UpdateOptions) {
		o.StandbyRegion = v
		o.enabledSetters["StandbyRegion"] = true
	}
...
func (srv *Postgresql) Update(DatabaseId string, optionalSetters ...UpdateOption) (*models.DedicatedDatabase, error) {
	...
	if options.enabledSetters["CrossRegionReplicas"] {
		params["crossRegionReplicas"] = options.CrossRegionReplicas
	}
	if options.enabledSetters["StandbyRegion"] {
		params["standbyRegion"] = options.StandbyRegion
	}
